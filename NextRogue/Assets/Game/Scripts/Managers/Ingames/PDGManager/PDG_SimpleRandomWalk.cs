...
public class PDG_SimpleRandomWalk : APDG
{
    ...
    protected override void RunProceduralGeneration() {
        ...
        InGameManager.Instance.PDGManager.TilemapVisualizer.PaintFloorTiles(floorPoses);
        WallGenerator.CreateWalls(floorPoses, InGameManager.Instance.PDGManager.TilemapVisualizer);

        InGameManager.Instance.PDGManager.Rooms.SaveRoom(floorPoses);
    }
    ...
    protected HashSet<Vector2Int> RunRandomWalk(SimpleRandomWalkData sRWData, Vector2Int pos) {
        ...
        InGameManager.Instance.PDGManager.Rooms.SaveRoom(floorPeses);
        return floorPeses;
    }
}
